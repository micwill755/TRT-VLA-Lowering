...
- **vision** → image embeddings. See :doc:`../export_modules/vision-example`.
- **language** → ``lm_hidden`` / prefix KV. See :doc:`../export_modules/language-example`.
- **action_context** → ``vl_embs`` fed as ``encoder_hidden_states``. See
  :doc:`../export_modules/action-context-example`.
